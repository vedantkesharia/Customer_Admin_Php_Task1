...
<body>
    <center>
    <h1>This is user page for customer1</h1><?php echo $_SESSION["username"] ?>
    <br>
    <br>
...
$sql = "INSERT INTO `customer1`(`Order_Date`, `Company`, `Owner`, `Item`, `Quantity`, `Weight`, `Request_for_shipment`, `Tracking_id`, `Shipment_size`, `Box_count`, `Specification`, `Checklist_quantity`) VALUES ('$orderdate','$company','$owner','$item','$quantity','$weight','$req','$track','$shipsize','$boxcount','$specification','$checklistquant')";
